...
func (e *Kucoin) overrideAPIURL(apiURL string) {
	e.apiURL = apiURL
}
...
func (e *Kucoin) RequestCandlesticks(operand types.Operand, startTimeTs int, intervalMinutes int) ([]types.Candlestick, error) {
	e.lock.Lock()
	defer e.lock.Unlock()
